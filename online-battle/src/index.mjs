...
const PRIVACY_PAGE = legalPage('コトダマっち プライバシーポリシー', `
  ...
  <p>音声、音声認識結果、マイク録音、表示名以外の自由入力の文章・画像、Apple AccountまたはGoogleアカウントの情報、メールアドレス、連絡先、位置情報は、オンライン対戦やランキングのためにサーバーへ送信・保存しません。表示名は、利用者がコトダマ杯で設定した場合に限り、オンライン対戦と週間ランキングに表示するため保存します。</p>
  <h2>お問い合わせ</h2>
